...
ProTheme getFullApps() {
  ...
  list.add(ProTheme(name: 'Investor', tag: 'New', widget: SMSplashScreen(), darkThemeSupported: true));
...
ProTheme getWorkingApps() {
  ProTheme theme = ProTheme(name: "Working Apps", tag: 'New', show_cover: true, sub_kits: []);
